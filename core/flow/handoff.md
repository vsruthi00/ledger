...
2. Update only the shards that changed this session. Edit in place; do not rewrite unrelated shards. Bump each touched shard's `last_updated`. Create a new shard only for genuinely new territory, and add its line to INDEX.md.
